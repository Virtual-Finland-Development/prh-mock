...
namespace PrhApi.Models.CodeGen.Model
{
    ...
    public partial class BoardMember : IEquatable<BoardMember>, IValidatableObject
    {
        ...
        public BoardMember(string role = default(string), string givenName = default(string), string middleNames = default(string), string lastName = default(string), DateTime dateOfBirth = default(DateTime), string nationality = default(string))
        {
