...
namespace PrhApi.Models.CodeGen.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EstablishmentRequest")]
    public partial class EstablishmentRequest : IEquatable<EstablishmentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EstablishmentRequest" /> class.
        /// </summary>
        /// <param name="nationalIdentifier">nationalIdentifier.</param>
        public EstablishmentRequest(string nationalIdentifier = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EstablishmentRequest {\n");
        ...
        {
            return this.Equals(input as EstablishmentRequest);
        }

        /// <summary>
        /// Returns true if EstablishmentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EstablishmentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EstablishmentRequest input)
        {
            if (input == null)
            {
                return false;
