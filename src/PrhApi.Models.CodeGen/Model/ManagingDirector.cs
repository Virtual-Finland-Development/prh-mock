...
namespace PrhApi.Models.CodeGen.Model
{
    ...
    /// ManagingDirector
    /// </summary>
    [DataContract(Name = "ManagingDirector")]
    public partial class ManagingDirector : IEquatable<ManagingDirector>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagingDirector" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ManagingDirector() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagingDirector" /> class.
        /// </summary>
        ...
        public ManagingDirector(string role = default(string), string givenName = default(string), string middleNames = default(string), string lastName = default(string), DateTime dateOfBirth = default(DateTime), string nationality = default(string))
        {
            ...
            if (role == null)
            {
                throw new ArgumentNullException("role is a required property for ManagingDirector and cannot be null");
            }
            this.Role = role;
            // to ensure "givenName" is required (not null)
            if (givenName == null)
            {
                throw new ArgumentNullException("givenName is a required property for ManagingDirector and cannot be null");
            }
            this.GivenName = givenName;
            // to ensure "middleNames" is required (not null)
            if (middleNames == null)
            {
                throw new ArgumentNullException("middleNames is a required property for ManagingDirector and cannot be null");
            }
            ...
            if (nationality == null)
            {
                throw new ArgumentNullException("nationality is a required property for ManagingDirector and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ManagingDirector {\n");
        ...
        {
            return this.Equals(input as ManagingDirector);
        }

        /// <summary>
        /// Returns true if ManagingDirector instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagingDirector to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagingDirector input)
        {
            if (input == null)
            {
                return false;
