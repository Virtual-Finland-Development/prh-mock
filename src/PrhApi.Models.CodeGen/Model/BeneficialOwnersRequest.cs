...
namespace PrhApi.Models.CodeGen.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BeneficialOwnersRequest")]
    public partial class BeneficialOwnersRequest : IEquatable<BeneficialOwnersRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BeneficialOwnersRequest" /> class.
        /// </summary>
        /// <param name="nationalIdentifier">nationalIdentifier.</param>
        public BeneficialOwnersRequest(string nationalIdentifier = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BeneficialOwnersRequest {\n");
        ...
        {
            return this.Equals(input as BeneficialOwnersRequest);
        }

        /// <summary>
        /// Returns true if BeneficialOwnersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BeneficialOwnersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BeneficialOwnersRequest input)
        {
            if (input == null)
            {
                return false;
