...
public static class ProductizerEndpoints
{
    ...
    {
        app.MapPost("NSG/Agent/LegalEntity/NonListedCompany/Establishment",
        ...
        app.MapPost("NSG/Agent/LegalEntity/NonListedCompany/Establishment/Write",
        ...
        app.MapPost("NSG/Agent/LegalEntity/NonListedCompany/BeneficialOwners",
        ...
        app.MapPost("NSG/Agent/LegalEntity/NonListedCompany/BeneficialOwners/Write",
        ...
        app.MapPost("NSG/Agent/LegalEntity/NonListedCompany/SignatoryRights",
        ...
        app.MapPost("NSG/Agent/LegalEntity/NonListedCompany/SignatoryRights/Write",
        ...
        app.MapPost("NSG/Agent/BasicInformation",
